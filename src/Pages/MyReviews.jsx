...
console.log(reviews)
  ...
  //   try {
  //     const response = await axios.put(`http://localhost:5000/reviews/${reviewId}`, updatedData);
  //     setReviews((prevReviews) =>
  //       prevReviews.map((review) => (review._id === reviewId ? response.data : review))
  //     );
  ...
  const handleDelete = async () => {
    try {
      if (reviewToDelete) {
        await axios.delete(`http://localhost:5000/reviews/${reviewToDelete._id}`);
        setReviews((prevReviews) =>
        ...
        {reviews.map((review) => (
          ...
          >
            <div className="flex items-center mb-4">
              ...
              />
              <div>
                <h3 className="text-lg font-semibold">{review.serviceTitle}</h3>
